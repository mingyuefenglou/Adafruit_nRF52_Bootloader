/*
 * 板级配置：nini_nrf52833_5883 ——【追踪器 tracker】的 Adafruit UF2 bootloader
...
#ifndef _NINI_NRF52833_5883_H
#define _NINI_NRF52833_5883_H

#define UICR_REGOUT0_VALUE UICR_REGOUT0_VOUT_2V7   // 片内稳压器输出挡位 2.7V（沿旧 v3 板，UICR 一次性烧写）
...
#define BUTTON_DFU        _PINNUM(0, 4)   // 主 DFU 按键 SW0：复位时按住 → 进 UF2 bootloader（U 盘模式）
